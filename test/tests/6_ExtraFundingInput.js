module.exports = function(setup) {
    ...
    contract('Contingency Plan', accounts => {
        ...
        context("before start time", async () => {
        ...
        context("after start time", async () => {
            ...
            context("1 wallet buying 10 eth worth of tokens", async () => {
                ...
                beforeEach(async () => {
                    ...
                    let tx = await ExtraFundingInputMarketing.sendTransaction({
                        value: buy_value,
                        from: wallet2
                    });
