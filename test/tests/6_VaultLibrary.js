module.exports = function(setup) {
    ...
    contract('Funding Vault - Library', accounts => {
        ...
        beforeEach(async () => {
            ...
            assetContract = await helpers.getContract("Test" + assetName);
            await TestBuildHelper.linkToFundingLib(assetContract);
            assetContract = await assetContract.new();
